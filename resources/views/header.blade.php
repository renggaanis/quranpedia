...
<!-- <link href="css/styleku.css" rel="stylesheet" id="styleku-css">
<link href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>

<nav class="navbar navbar-expand-lg p-0">
        <a class="navbar-brand" href="index.php"><h1>Ngaji<h1 class="text-success col-md-12">Online</h3></h1></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-outline-success" href="member">Data User</a>
                </li>                               
            </ul>
        </div>
</nav> -->
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="public/homeawal/assets/img/favicon.ico" />
        ...
        <div id="nav">
            ...
            <div id="nav-top">
                <div class="container">
                    ...
                    <!-- logo -->
                    <div class="nav-logo">
                        <a href="/webquranpedia/dashboard" class="logo"><img src="public/frontend/img/header1.png" alt=""></a>
                    </div>
                    <!-- /logo -->
            ...
            <div id="nav-bottom">
                <div class="container">
                    <!-- nav -->
                    <ul class="nav-menu">
                        <li><a href="/webquranpedia/dashboard">Kembali Beranda</a></li>
