        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    You are logged in!
                    <br>
                    <a href="http://localhost/webquranpedia/pelanggan" class="btn btn-info btn-sm">Home</a>
                    @if(auth()->user()->role == 'admin')
                    <a href="http://localhost/webquranpedia/profilebackend" class="btn btn-info btn-sm">Backend</a>
                    @endif
                    @if(auth()->user()->role == 'kontributor')
                    <a href="http://localhost/webquranpedia/kontributor" class="btn btn-info btn-sm">Backend</a>
                    @endif
                </div>
            </div>
        </div>
